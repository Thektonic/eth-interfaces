    ...
    IERC721Errors
{
    ...
    constructor(string memory name_, string memory symbol_) {
        ...
        _safeMint(_msgSenderERC721A(), 30);
    }
    ...
    function supportsInterface(
        bytes4 interfaceId
    ) public view virtual override(IERC165, IERC721A) returns (bool) {
    ...
    function _afterTokenTransfers(
        ...
        for (uint256 i = 0; i < quantity; i++) {
            _update(from, to, startTokenId + i);
        }
    }
    ...
    function royaltyInfo(
        ...
        if (isApprovedForAll(_msgSenderERC721A(), address(this))) {
            return (address(0), 0);
        } else {
            return (address(0), 0);
        }
