...
func (ierc20 *Ierc20) PackApprove(spender common.Address, value *big.Int) []byte {
	enc, err := ierc20.abi.Pack("approve", spender, value)
	if err != nil {
		panic(err)
	}
	return enc
...
func (ierc20 *Ierc20) TryPackApprove(spender common.Address, value *big.Int) ([]byte, error) {
	return ierc20.abi.Pack("approve", spender, value)
}
...
func (ierc20 *Ierc20) PackDecimals() []byte {
	enc, err := ierc20.abi.Pack("decimals")
	if err != nil {
		panic(err)
	}
	return enc
...
func (ierc20 *Ierc20) TryPackDecimals() ([]byte, error) {
	return ierc20.abi.Pack("decimals")
}
...
func (ierc20 *Ierc20) UnpackDecimals(data []byte) (uint8, error) {
	out, err := ierc20.abi.Unpack("decimals", data)
	if err != nil {
...
func (ierc20 *Ierc20) UnpackName(data []byte) (string, error) {
	out, err := ierc20.abi.Unpack("name", data)
	if err != nil {
...
func (ierc20 *Ierc20) PackSymbol() []byte {
	enc, err := ierc20.abi.Pack("symbol")
	if err != nil {
		panic(err)
	}
	return enc
...
func (ierc20 *Ierc20) UnpackSymbol(data []byte) (string, error) {
	out, err := ierc20.abi.Unpack("symbol", data)
	if err != nil {
		return *new(string), err
	}
	out0 := *abi.ConvertType(out[0], new(string)).(*string)
...
func (ierc20 *Ierc20) PackTransfer(to common.Address, value *big.Int) []byte {
	enc, err := ierc20.abi.Pack("transfer", to, value)
	if err != nil {
		panic(err)
	}
	return enc
...
func (ierc20 *Ierc20) TryPackTransfer(to common.Address, value *big.Int) ([]byte, error) {
	return ierc20.abi.Pack("transfer", to, value)
}
...
func (ierc20 *Ierc20) PackTransferFrom(from common.Address, to common.Address, value *big.Int) []byte {
	enc, err := ierc20.abi.Pack("transferFrom", from, to, value)
	if err != nil {
		panic(err)
	}
	return enc
...
func (ierc20 *Ierc20) TryPackTransferFrom(from common.Address, to common.Address, value *big.Int) ([]byte, error) {
	return ierc20.abi.Pack("transferFrom", from, to, value)
}
...
func (ierc20 *Ierc20) UnpackApprovalEvent(log *types.Log) (*Ierc20Approval, error) {
	event := "Approval"
	if log.Topics[0] != ierc20.abi.Events[event].ID {
...
func (ierc20 *Ierc20) UnpackError(raw []byte) (any, error) {
	if bytes.Equal(raw[:4], ierc20.abi.Errors["ERC20InsufficientAllowance"].ID.Bytes()[:4]) {
		return ierc20.UnpackERC20InsufficientAllowanceError(raw[4:])
	}
	if bytes.Equal(raw[:4], ierc20.abi.Errors["ERC20InsufficientBalance"].ID.Bytes()[:4]) {
		return ierc20.UnpackERC20InsufficientBalanceError(raw[4:])
	}
	if bytes.Equal(raw[:4], ierc20.abi.Errors["ERC20InvalidApprover"].ID.Bytes()[:4]) {
		return ierc20.UnpackERC20InvalidApproverError(raw[4:])
	}
	if bytes.Equal(raw[:4], ierc20.abi.Errors["ERC20InvalidReceiver"].ID.Bytes()[:4]) {
		return ierc20.UnpackERC20InvalidReceiverError(raw[4:])
	}
	if bytes.Equal(raw[:4], ierc20.abi.Errors["ERC20InvalidSender"].ID.Bytes()[:4]) {
		return ierc20.UnpackERC20InvalidSenderError(raw[4:])
	}
	if bytes.Equal(raw[:4], ierc20.abi.Errors["ERC20InvalidSpender"].ID.Bytes()[:4]) {
		return ierc20.UnpackERC20InvalidSpenderError(raw[4:])
	}
...
func (ierc20 *Ierc20) UnpackERC20InsufficientAllowanceError(raw []byte) (*Ierc20ERC20InsufficientAllowance, error) {
	out := new(Ierc20ERC20InsufficientAllowance)
	if err := ierc20.abi.UnpackIntoInterface(out, "ERC20InsufficientAllowance", raw); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (ierc20 *Ierc20) UnpackERC20InsufficientBalanceError(raw []byte) (*Ierc20ERC20InsufficientBalance, error) {
	out := new(Ierc20ERC20InsufficientBalance)
	if err := ierc20.abi.UnpackIntoInterface(out, "ERC20InsufficientBalance", raw); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (ierc20 *Ierc20) UnpackERC20InvalidApproverError(raw []byte) (*Ierc20ERC20InvalidApprover, error) {
	out := new(Ierc20ERC20InvalidApprover)
	if err := ierc20.abi.UnpackIntoInterface(out, "ERC20InvalidApprover", raw); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (ierc20 *Ierc20) UnpackERC20InvalidReceiverError(raw []byte) (*Ierc20ERC20InvalidReceiver, error) {
	out := new(Ierc20ERC20InvalidReceiver)
	if err := ierc20.abi.UnpackIntoInterface(out, "ERC20InvalidReceiver", raw); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (ierc20 *Ierc20) UnpackERC20InvalidSenderError(raw []byte) (*Ierc20ERC20InvalidSender, error) {
	out := new(Ierc20ERC20InvalidSender)
	if err := ierc20.abi.UnpackIntoInterface(out, "ERC20InvalidSender", raw); err != nil {
		return nil, err
	}
	return out, nil
}
...
func (ierc20 *Ierc20) UnpackERC20InvalidSpenderError(raw []byte) (*Ierc20ERC20InvalidSpender, error) {
	out := new(Ierc20ERC20InvalidSpender)
	if err := ierc20.abi.UnpackIntoInterface(out, "ERC20InvalidSpender", raw); err != nil {
		return nil, err
	}
	return out, nil
}
